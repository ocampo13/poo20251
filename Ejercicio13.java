public class Ejercicio13 {
    public static void main(String[] args) {
        ...
        double media = (double) sumaArreglo / a.length; // Se debe hacer el casting para obtener decimales
        System.out.println("Media del arreglo: " + media);

        // Definir la cantidad de elementos por encima y por debajo de la media
        ...
        System.out.println();
    } // ← Aquí agregamos la llave de cierre que faltaba
}
